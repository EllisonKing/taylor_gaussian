...
from lpipsPyTorch import lpips # add
        ...
        for config in validation_configs:
            if config['cameras'] and len(config['cameras']) > 0:
                ...
                for idx, viewpoint in enumerate(config['cameras']):
                    ...
                    alex_lpips_list.append(lpips(image[None], gt_image[None], net_type='alex'))  # ADD
                    lpips_list.append(lpips(image[None], gt_image[None], net_type='vgg'))  # ADD
